---
title: Health
description: A tiny page that tells you whether the server is responding.
---

The **Health** page is the simplest in the dashboard: it pings the server and
...
[Self-host](/deploy-and-operate/self-host/), which covers the command-line
healthcheck.
